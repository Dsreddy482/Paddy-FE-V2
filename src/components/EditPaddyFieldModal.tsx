...
interface EditPaddyFieldModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUpdate: (field: PaddyField) => Promise<void>;
  field: PaddyField | null;
}

export const EditPaddyFieldModal: React.FC<EditPaddyFieldModalProps> = ({
  isOpen,
  onClose,
  onUpdate,
  field,
}) => {
  const [formData, setFormData] = useState<PaddyField>({
    id: '',
    fieldName: '',
    location: '',
    area: 0,
